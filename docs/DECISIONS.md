...
| D-050 | 2026-07-10 | Tracks carry six seeded-random pickup slots: one ammo, one turbo, one cash, one repair, and two traps. Collected slots respawn after 18 seconds at a new spaced track-relative position; active type caps preserve that mix. Rewards are reduced to 25 ammo, 35% turbo, 15% repair, and $100. | Repeated play showed the old 11–13 fixed markers and 10-second full-strength respawns flooded every lap with bonuses and made resource management irrelevant. |
| D-051 | 2026-07-10 | The race HUD presents all resources as amount remaining: HULL, AMMO, TURBO/OVERCHARGE, and MINES, with exact numeric values. Empty turbo latches off until boost is released and at least 10% charge recovers. | Damage-as-fill ran opposite to every other bar, mine emptiness was invisible, overcharge was ambiguous, and holding boost at zero caused a recharge/VFX flicker loop. |
